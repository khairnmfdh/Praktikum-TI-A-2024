public class ifElse {
    public static void main(String[] args) {
        ...
        int umurOrang = 10;
        if (genderOrang.equals("Perempuan") && umurOrang >= 10) { // kondisi gender harus Perempuan DAN umur harus >= 10
                                                                  // untuk true
        ...
        // tanpa else --> masih bisa jalan. Jika tidak memerlukan
        // output/perubahan/process jika kondisi tidak terpenuhi
        nilai = 80;
        if (nilai >= 80) {
            System.out.println("Anda dapat A");
        } else if (nilai >= 60) {
        ...
        switch (abc) { // bracket hanya sepasang untuk membungkus seluruh case-case pada switch case
            ...
            default: // sama aja else, tidak wajib ada jika tidak diperlukan output/perubahan untuk
                     // nilai yang di luar kondisi
        ...
        // INGAT!!! YANG [KIRI] ITU JIKA KONDISI TRUE : YANG [KANAN] ITU JIKA KONDISI
        // FALSE
        ...
        if (warna == "Pink") { // blok kode if else 1
            // spasi baris di sini hanya untuk mempermudah melihat nested if-else. Tidak
            // perlu spasi
